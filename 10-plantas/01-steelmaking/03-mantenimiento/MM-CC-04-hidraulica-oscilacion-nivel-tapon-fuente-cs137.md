...
| C-16 en función de ESR — Encargado de Seguridad Radiológica (con licencia CNSNS; titular legal según MS-ACE-07) | Único autorizado para operar el obturador, bloquear, medir tasa de dosis, pruebas de fuga, inventario | R / A (radiación) |
...
flowchart TD
    ...
    B -- "Sí" --> C["ESR (C-16) cierra obturador,<br/>pone su candado y mide"]
    C --> D{"¿Tasa de dosis en punto de trabajo<br/>< 2 × fondo?"}
    D -- "No" --> E["🛑 No trabajar · alejarse ≥ 3 m<br/>plan de emergencia radiológica"]
...
| Tasa de dosis con obturador cerrado en punto de trabajo | µSv/h | Fondo (≈ 0.1–0.3) | < 2 × fondo [Validar con ESR] | **≥ 2 × fondo = 🛑** | No trabajar; alejarse ≥ 3 m; el ESR (C-16) aplica el plan de emergencia (MS-ACE-07) | Radiámetro calibrado | Cada intervención |
...
|---|---|---|---|
| Radiación ionizante (Cs-137) | Dosis indebida, efectos a la salud | Solo el ESR (C-16) opera el obturador; candado del ESR; medición antes de trabajar; tiempo–distancia–blindaje | Radiámetro < 2 × fondo; registro del ESR |
...
| Argón | Asfixia en zonas bajas | Válvula cerrada y bloqueada; ventilación | O₂ 19.5–23.5 % (MS-ACE-06) |
...
| 2 | Cierra la fuente | El ESR (C-16) cierra el obturador, coloca su candado y tarjeta | Obturador cerrado con candado del ESR | ★ | C-16 (ESR) |
| 3 | Mide tasa de dosis | El ESR (C-16) mide en el punto de trabajo y a 1 m del detector | < 2 × fondo, anotado en el permiso | ★ | C-16 (ESR) |
...
| 10 | ESR abre la fuente | Con el personal fuera de la zona controlada (salvo POE con dosímetro), el ESR (C-16) retira su candado y abre el obturador | Indicador "abierto" y cuentas estables | ★ | C-16 (ESR) |
...
| Indicador de obturador no coincide | Mecanismo dañado | 🛑 Alejarse ≥ 3 m y delimitar; el ESR (C-16) mide y bloquea | C-16 (ESR), C-06 |
...
|---|---|---|---|---|---|
| S-22 Técnico Hidráulico | 3 | 32 (servohidráulica, limpieza de aceite, acumuladores NOM-020) | 40 h | Pasos 4, 5, 8 | 24 meses (TD-P07) |
| S-21 Instrumentista (POE) | 3 | 24 (oscilación, nivel) + protección radiológica para POE (NOM-012, curso reconocido por CNSNS) | 3 calibraciones con ESR | Pasos 4, 7, 9, 11 | 24 meses (TD-P07) en mantenimiento; protección radiológica (POE) y trabajo eléctrico en tableros (NOM-029) 12 meses |
| C-16 en función de ESR | 4 | Acreditación CNSNS | — | Pasos 2, 3, 10 | Según licencia CNSNS; evaluación interna 12 meses |
| S-19 Mecánico | 3 | 8 (mesa de oscilación, tapón) + concientización radiológica | 2 intervenciones | Pasos 4, 6 | 24 meses (TD-P07); radiológica 12 meses |
| Personal de CC no POE | 1 | Concientización radiológica (2) | — | Reconoce señalización y zona | 12 meses (fuentes radiactivas) |
...
**Verificación ★:** ¿línea sin acero y autorización de C-06 (paso 1)? · ¿solo el ESR (C-16) operó el obturador y puso su candado (pasos 2, 10)? · ¿midió < 2 × fondo antes de trabajar (paso 3)? · ¿LOTO con candado personal y energía cero probada (pasos 4, 5)? · ¿acumuladores a 0 bar y perno del tapón puesto? · ¿retiró solo el LOTO hidráulico necesario con personal fuera de la mesa (paso 8)? · ¿retiró el LOTO restante en orden (paso 12)? · ¿análisis de oscilación registrado? · ¿liberación firmada también por el ESR (paso 13)?
