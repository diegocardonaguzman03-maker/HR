...
| Energía eléctrica y movimiento del horno con personas en plataforma | Electrocución, aplastamiento | ★ Bloqueo con llave cautiva o LOTO (MS-ACE-02) antes de subir a plataforma de EBT o de bóveda | Llave en poder de quien sube; tablero de llaves |
...
| CO en plataforma superior | Intoxicación | Detector personal de CO (alarma 25 ppm [Validar con SSO]) | Prueba de detector al inicio de turno |
...
- ★ **Antes de subir a la plataforma del EBT o a la de bóveda/electrodos:** arco apagado, interruptor del horno abierto, inclinación y giro de bóveda bloqueados con **llave cautiva** (rutina) o **LOTO completo** (entrada a bóveda, bajo el horno o trabajo > 15 min) según MS-ACE-02 [Validar con Seguridad el esquema de llave cautiva].
...
| 11 | Bloquea antes de subir a la plataforma del EBT | Interruptor del horno abierto; inclinación y bóveda bloqueadas con llave cautiva; la llave la lleva quien sube. | Llave en poder del trabajador | ★ | S-02 |
...
| 17 | Retira el bloqueo | Bajan todos de la plataforma; se devuelve la llave al tablero; conteo de personas. | Plataforma vacía | ★ | S-02 / S-01 |
...
|---|---|---|---|
| Δ caudal > 2%, vapor, manchas húmedas o llama anormal (fuga de agua) | Panel o bóveda perforados; fuga en manguera | 🛑 Arco bloqueado. **No inclines el horno** (el agua quedaría atrapada bajo el metal). Cierra el agua del circuito identificado desde el púlpito. Evacua plataforma y piso del horno. Deja que el agua se evapore con el horno quieto. | C-05, C-04, Mantenimiento (MM-EAF-01), C-16 |
...
| S-02 Segundo Hornero | 3 | 16 | 80 h / 30 preparaciones | Pasos 3, 8, 11, 13, 14, 17 | 24 meses |
| S-03 Tercer Hornero | 2 (3 para suplir a S-02) | 12 | 40 h / 15 preparaciones | Pasos 14 y 17 bajo supervisión | 24 meses |
| C-05 Supervisor de Hornos | 4 (evaluador) | 24 + formación de evaluador | — | Evaluación de la respuesta a fuga de agua | 24 meses |
...
3. Aplica la llave cautiva o LOTO antes de subir y la retira con conteo de personas.
4. Verifica la compuerta cerrada y el llenado del EBT con arena seca.
5. Proyecta sin formar charcos ni proyectar sobre el baño.
